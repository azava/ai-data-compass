...
- Review clear documentation issues across the repository, including READMEs, instructions, templates, backlog, and integration docs. Use the configured documentation-validation procedure; if none exists, look for the skill under `.ai-data-compass/skills/`. Follow its final validation and report unresolved issues. If neither is available, tell the user and require review.
