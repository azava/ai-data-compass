...
1. Read `.ai-data-compass/skills/security-audit/SKILL.md` and follow it as the source of truth.
2. Run only `.ai-data-compass/skills/security-audit/scripts/security-surface.sh`.
...
The canonical skill, references, scripts, and tests remain under `.ai-data-compass/skills/security-audit/`.
